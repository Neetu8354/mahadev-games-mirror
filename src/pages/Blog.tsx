  ...
  const jsonLd = [
    {
      ...
      url: "https://mahadevbooksguide.live/blog",
      description: "Expert guides on cricket betting, IPL strategy, live casino, Teen Patti, Andar Bahar and online betting in India.",
      publisher: { "@type": "Organization", name: "Mahadev Book", url: "https://mahadevbooksguide.live" },
      blogPost: BLOG_POSTS.map(p => ({
        "@type": "BlogPosting",
        headline: p.title,
        url: `https://mahadevbooksguide.live/blog/${p.slug}`,
