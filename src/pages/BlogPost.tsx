...
const BlogPost = () => {
  ...
  const url = `https://mahadevbooksguide.live/blog/${post.slug}`;
  ...
  const jsonLd: object[] = [
    {
      ...
      image: [`https://mahadevbooksguide.live/og-image.jpg`],
      datePublished: post.publishedAt,
      dateModified: post.updatedAt,
      author: { "@type": "Organization", name: post.author, url: "https://mahadevbooksguide.live" },
      publisher: {
        "@type": "Organization",
        name: "Mahadev Book",
        logo: { "@type": "ImageObject", url: "https://mahadevbooksguide.live/favicon.png" },
      },
    ...
    },
    {
      ...
      "@type": "BreadcrumbList",
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "Home", item: "https://mahadevbooksguide.live/" },
        { "@type": "ListItem", position: 2, name: "Blog", item: "https://mahadevbooksguide.live/blog" },
