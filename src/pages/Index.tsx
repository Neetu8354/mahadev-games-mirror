  ...
  const jsonLd = [
    {
      ...
      url: "https://mahadevbooksguide.live/",
      logo: "https://mahadevbooksguide.live/favicon.png",
    ...
    },
    {
      ...
      potentialAction: {
        "@type": "SearchAction",
        target: "https://mahadevbooksguide.live/blog?q={search_term_string}",
    ...
    },
    {
      "@context": "https://schema.org",
      "@type": "BreadcrumbList",
      itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: "https://mahadevbooksguide.live/" }],
    },
  ];
