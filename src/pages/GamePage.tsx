...
const GamePage = () => {
  ...
  const url = `https://mahadevbooksguide.live/games/${game.slug}`;
  const jsonLd: object[] = [
    {
      ...
      inLanguage: "en-IN",
      isPartOf: { "@type": "WebSite", name: "Mahadev Book", url: "https://mahadevbooksguide.live/" },
    },
    {
      "@context": "https://schema.org",
      "@type": "Service",
      ...
      provider: { "@type": "Organization", name: "Mahadev Book", url: "https://mahadevbooksguide.live/" },
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Games", item: "https://mahadevbooksguide.live/games" },
