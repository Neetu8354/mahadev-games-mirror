...
const GamePage = () => {
  ...
  const url = `https://www.mahadevbets.live/games/${game.slug}`;
  const jsonLd: object[] = [
    {
      ...
      inLanguage: "en-IN",
      isPartOf: { "@type": "WebSite", name: "Mahadev Book", url: "https://www.mahadevbets.live/" },
    },
    {
      "@context": "https://schema.org",
      "@type": "Service",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Games", item: "https://www.mahadevbets.live/games" },
